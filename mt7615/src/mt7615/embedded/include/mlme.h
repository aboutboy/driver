...
#else
#if defined(MT7603_FPGA) || defined(MT7628_FPGA) || defined(MT7636_FPGA) || defined(MT7637_FPGA) || defined(MT7615_FPGA) || defined(MT7622_FPGA)
...
#ifdef PALLADIUM
#define MAX_CHANNEL_TIME            140*2000	/* unit: msec, for single band scan */
#else
...
#define SET_RTS_THLD(num,len) ((num << 25)|(len))
