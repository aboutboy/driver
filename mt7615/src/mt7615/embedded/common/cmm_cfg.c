...
INT SetNRPDDebug(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
    UINT8	i;
	CHAR	*value = 0;
	INT     status = TRUE;
    ...
    {   
        MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s: Wrong parameter format!! \n", __FUNCTION__));
        MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, ("%s: Please use input format like X:X:X:X:X:X:X:X (X = 0,1)!! \n", __FUNCTION__));
        return FALSE;
    }
	...
	for (i = 0, value = rstrtok(arg,":"); value; value = rstrtok(NULL,":"), i++)
	{
		...
		{
            case 0:
                pAd->EntryOneSTADebug   = simple_strtol(value, 0, 10);
                break;
            case 1:
                pAd->EntryVHTModeDebug  = simple_strtol(value, 0, 10);
                break;
            case 2:
                pAd->Entry1NSSDebug     = simple_strtol(value, 0, 10);
                break;
            case 3:
                pAd->EntryRSSIDebug     = simple_strtol(value, 0, 10);
                break;
            case 4:
                pAd->DepartOneSTADebug  = simple_strtol(value, 0, 10);
                break;
            case 5:
                pAd->DepartPERDebug     = simple_strtol(value, 0, 10);
                break;
            case 6:
                pAd->DepartTIMEOUTDebug = simple_strtol(value, 0, 10);
                break;
            case 7:
                pAd->DepartNULLACKDebug = simple_strtol(value, 0, 10);
                break;
            case 8:
                pAd->NRPDDebugLog       = simple_strtol(value, 0, 10);
                break;    
			default:
			{
				status = FALSE;
	...
	MTWF_LOG(DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%s: EntryOneSTADebug   = %d \n", __FUNCTION__, pAd->EntryOneSTADebug));
    MTWF_LOG(DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%s: EntryVHTModeDebug  = %d \n", __FUNCTION__, pAd->EntryVHTModeDebug));
    MTWF_LOG(DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%s: Entry1NSSDebug     = %d \n", __FUNCTION__, pAd->Entry1NSSDebug));
    MTWF_LOG(DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%s: EntryRSSIDebug     = %d \n", __FUNCTION__, pAd->EntryRSSIDebug));
    MTWF_LOG(DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%s: DepartOneSTADebug  = %d \n", __FUNCTION__, pAd->DepartOneSTADebug));
    MTWF_LOG(DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%s: DepartPERDebug     = %d \n", __FUNCTION__, pAd->DepartPERDebug));
    MTWF_LOG(DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%s: DepartTIMEOUTDebug = %d \n", __FUNCTION__, pAd->DepartTIMEOUTDebug));
    MTWF_LOG(DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%s: DepartNULLACKDebug = %d \n", __FUNCTION__, pAd->DepartNULLACKDebug));
	MTWF_LOG(DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%s: NRPDDebugLog       = %d \n", __FUNCTION__, pAd->NRPDDebugLog));
    
    return status;
}

INT SetNRPDEn(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
    UINT8	i;
	CHAR	*value = 0;
	INT     status = TRUE;
	...
	for (i = 0, value = rstrtok(arg,":"); value; value = rstrtok(NULL,":"), i++)
	{
		...
		{
            case 0:
                pAd->fgNRPDDetectEnable = simple_strtol(value, 0, 10);
                break;
			default:
			{
				status = FALSE;
	...
	MTWF_LOG(DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%s: pAd->fgNRPDDetectEnable = %d \n", __FUNCTION__, pAd->fgNRPDDetectEnable));
    
    return status;
}

INT SetNRPDCtrl(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
    UINT8	i;
	CHAR	*value = 0;
	INT     status = TRUE;
    //INT8    LargePowerTh = 0;
    //UINT8   RSSITh_HighPower = 0;
    //UINT8   RSSITh_LowPower = 0;
    //UINT8   RxCountTh = 0;
    //UINT8   TimeOutTh = 0;
	...
	for (i = 0, value = rstrtok(arg,":"); value; value = rstrtok(NULL,":"), i++)
	{
		...
		{
            case 0:
                pAd->RSSITh = simple_strtol(value, 0, 10);  // 2 symbol representation
                break;
            case 1:
                pAd->RxCountTh = simple_strtol(value, 0, 10);  // 2 symbol representation
                break;
            case 2:
                pAd->TimeOutTh = simple_strtol(value, 0, 10);  // 3 symbol representation
                break;
			default:
			{
				status = FALSE;
	...
	MTWF_LOG(DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%s: RSSITh            = %d \n", __FUNCTION__, pAd->RSSITh));
    MTWF_LOG(DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%s: RxCountTh         = %d \n", __FUNCTION__, pAd->RxCountTh));
    MTWF_LOG(DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%s: TimeOutTh         = %d \n", __FUNCTION__, pAd->TimeOutTh));
    
    return status;
}

INT SetNRPDThCtrl(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
    UINT8   i;
    CHAR    *value = 0;
    INT     status = TRUE;
    ...
    for (i = 0, value = rstrtok(arg,":"); value; value = rstrtok(NULL,":"), i++)
    {
        ...
        {
            case 0:
                pAd->c4NrRssiTh = simple_strtol(value, 0, 10);
                break;
            case 1:
                pAd->c4ChgTestPathTh = simple_strtol(value, 0, 10);
                break;    
            default:
            {
                status = FALSE;
    ...
    MTWF_LOG(DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%s: pAd->c4NrRssiTh: %d, pAd->c4ChgTestPathTh: %d \n", __FUNCTION__,
                                                            pAd->c4NrRssiTh, pAd->c4ChgTestPathTh));
...
INT SetNRPDModeCtrl(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
    ...
    for (i = 0, value = rstrtok(arg,":"); value; value = rstrtok(NULL,":"), i++)
    {
        ...
        {
            case 0:
                pAd->fgTxSpur = simple_strtol(value, 0, 10);
                break;
            case 1:
                pAd->fgNrFloating = simple_strtol(value, 0, 10);
                break;    
            case 2:
                pAd->fgACI = simple_strtol(value, 0, 10);
                break;    
            case 3:
                pAd->c4MaxInRssiTh = simple_strtol(value, 0, 10);
                break;
            case 4:
                pAd->ucACIConfidenceCntTh = simple_strtol(value, 0, 10);
                break;
            case 5:
    ...
    MTWF_LOG(DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%s: fgTxSpur: %d, fgNrFloating: %d, fgACI: %d\n", __FUNCTION__,
                                                            pAd->fgTxSpur, pAd->fgNrFloating, pAd->fgACI));

    MTWF_LOG(DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_OFF, ("%s: c4MaxInRssiTh: %d, ucACIConfidenceCntTh: %d, ucMAxInConfidenceCntTh: %d \n", __FUNCTION__,
                                                            pAd->c4MaxInRssiTh, pAd->ucACIConfidenceCntTh, pAd->ucMAxInConfidenceCntTh));
