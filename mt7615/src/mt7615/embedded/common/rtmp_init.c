...
VOID UserCfgInit(RTMP_ADAPTER *pAd)
{
    ...
    pAd->NullFrameCount          =     0;
    pAd->NullFrameFailCount      =     0;
    pAd->TempRxCount             =     0;
    pAd->RSSITh                  =    10;
    pAd->RSSITh_HighPower        =    25;
    pAd->RSSITh_LowPower         =    10;
    pAd->LargePowerTh            =   -90;
    pAd->RxCountTh               =     5;
    pAd->TimeOutTh               =   200;  // 20s
    pAd->EntryOneSTADebug        =  TRUE;
    pAd->EntryVHTModeDebug       =  TRUE;
    pAd->Entry1NSSDebug          =  TRUE;
    pAd->EntryRSSIDebug          =  TRUE;
    pAd->DepartOneSTADebug       =  TRUE;
    pAd->DepartPERDebug          =  TRUE;
    pAd->DepartTIMEOUTDebug      =  TRUE;
    pAd->DepartNULLACKDebug      =  TRUE;
    pAd->NRPDDebugLog            = FALSE;

    pAd->fgNRPDDetectEnable      =  TRUE;
    pAd->fgDefaultRSSIAccess     =  TRUE;

    pAd->fgRFCSDDone             = FALSE;
    pAd->Backto4Tcount           =     0;
    pAd->Backto4TThres           =    20;  // 2s
    pAd->BackUpCSDConfig         =     0;

    pAd->ucACIConfidenceCnt      =     0;
    pAd->ucACIConfidenceCntTh    =    10;
    ...
    pAd->c4NrRssiTh              = -40;
    pAd->c4ChgTestPathTh         = -30;
    pAd->c4MaxInRssiTh           = -40;
