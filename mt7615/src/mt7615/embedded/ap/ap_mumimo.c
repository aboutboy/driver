...
INT SetMuProfileProc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
    ...
    param.valid = (BOOLEAN)simple_strtol(pValid, 0, 10);
...
INT SetGroupTblEntryProc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
    ...
    param.numUser = simple_strtol(pNumUser, 0, 10);
    param.BW = simple_strtol(pBw, 0, 10);
    param.PFIDUser0 = simple_strtol(ppfid0, 0, 10);
    param.PFIDUser1 = simple_strtol(ppfid1, 0, 10);
    param.PFIDUser2 = simple_strtol(ppfid2, 0, 10);
    param.PFIDUser3 = simple_strtol(ppfid3, 0, 10);
    param.fgIsShortGI = (BOOLEAN) simple_strtol(psgi, 0, 10);
    param.fgIsUsed = (BOOLEAN) simple_strtol(pused, 0, 10);
    param.fgIsDisable = (BOOLEAN) simple_strtol(pdis, 0, 10);
    
    param.initMcsUser0 = simple_strtol(pinitMcsUser0, 0, 10);
    param.initMcsUser1 = simple_strtol(pinitMcsUser1, 0, 10);
    param.initMcsUser2 = simple_strtol(pinitMcsUser2, 0, 10);
    param.initMcsUser3 = simple_strtol(pinitMcsUser3, 0, 10);
    
    param.dMcsUser0 = simple_strtol(pdMcsUser0, 0, 10);
    param.dMcsUser1 = simple_strtol(pdMcsUser1, 0, 10);
    param.dMcsUser2 = simple_strtol(pdMcsUser2, 0, 10);
    param.dMcsUser3 = simple_strtol(pdMcsUser3, 0, 10);

    param.NS0 = simple_strtol(pNs0, 0, 10);
...
INT SetClusterTblEntryProc(RTMP_ADAPTER *pAd, RTMP_STRING *arg)
{
    ...
    param.gidUserMemberStatus[0] = simple_strtol(pLowGidUserMemberStatus, 0, 16);
    param.gidUserMemberStatus[1] = simple_strtol(pHighGidUserMemberStatus, 0, 16);
    param.gidUserPosition[0] = simple_strtol(pLowGidUserPosition0, 0, 16);
    ...
    )
{
        ...
        MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR,
                        ("%s: type = %u, length = %u\n", 
                        __FUNCTION__, ptr->type, ptr->length));
	...
	Ret = hqa_wifi_test_mu_get_init_mcs(pAd, gid, &init_mcs);
        ...
        if (Ret == 0) {
                ...
                MTWF_LOG(DBG_CAT_TEST, DBG_SUBCAT_ALL, DBG_LVL_ERROR,
                                ...
                                __FUNCTION__, init_mcs.user0InitMCS));
                MTWF_LOG(DBG_CAT_TEST, DBG_SUBCAT_ALL, DBG_LVL_ERROR,
                                ("%s, init_mcs.user1InitMCS:%u\n", 
                                __FUNCTION__, init_mcs.user1InitMCS));
                MTWF_LOG(DBG_CAT_TEST, DBG_SUBCAT_ALL, DBG_LVL_ERROR,
                                ("%s, init_mcs.user1InitMCS:%u\n", 
                                __FUNCTION__, init_mcs.user2InitMCS));
                MTWF_LOG(DBG_CAT_TEST, DBG_SUBCAT_ALL, DBG_LVL_ERROR,
                                ("%s, init_mcs.user1InitMCS:%u\n", 
                                __FUNCTION__, init_mcs.user3InitMCS));
        }
        MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_OFF,
...
INT32 hqa_mu_cal_init_mcs(PRTMP_ADAPTER pAd, RTMP_STRING *arg)
{
	...
	MTWF_LOG(DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_OFF,
        ...
        num_of_user = simple_strtoul(pnum_of_user, 0, 10);
        bandwidth = simple_strtoul(pbandwidth, 0, 10);

        nss_of_user0 = simple_strtoul(pnss_of_user0, 0, 10);
        nss_of_user1 = simple_strtoul(pnss_of_user1, 0, 10);
        nss_of_user2 = simple_strtoul(pnss_of_user2, 0, 10);
        nss_of_user3 = simple_strtoul(pnss_of_user3, 0, 10);

        pf_mu_id_of_user0 = simple_strtoul(ppf_mu_id_of_user0, 0, 10);
        pf_mu_id_of_user1 = simple_strtoul(ppf_mu_id_of_user1, 0, 10);
        pf_mu_id_of_user2 = simple_strtoul(ppf_mu_id_of_user2, 0, 10);
        pf_mu_id_of_user3 = simple_strtoul(ppf_mu_id_of_user3, 0, 10);

        num_of_txer = simple_strtoul(pnum_of_txer, 0, 10);
        group_index = simple_strtoul(arg, 0, 10);
...
INT32 hqa_mu_get_qd(PRTMP_ADAPTER pAd, RTMP_STRING *arg)
{
	...
	subcarrier_idx = simple_strtoul(arg, 0, 10);
        ...
        MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_OFF,
                ("%s:CMD %s\n", __FUNCTION__, Ret == TRUE ? "Success":"Fail"));
