...
#define RSSI_THRESHOLD_1R_DETECTION	     10
#define PER_THRESHOLD                    50
#define NR_TIMEOUT_THRESHOLD             20
#define NULL_ACK_THRESHOLD               40
#define NR_CHECK_FRAME_NUM                5
#define RX_SUCCESS_THRESHLOD              5
...
VOID NRPDACICtrl(struct _RTMP_ADAPTER *pAd);
#endif /* NR_PD_DETECTION */
