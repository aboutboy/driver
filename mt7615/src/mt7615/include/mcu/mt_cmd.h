...
enum EXT_CMD_TYPE {
    ...
    EXT_CMD_ID_CMW270_FEATURE_CTRL = 0x78,
...
#ifdef NR_PD_DETECTION
typedef enum _CMW270_ACTION_CATEGORY
{
    CMW270_TX = 0,
    CMW270_RX,
    CMW270_TXPWR,
    ...
    CMW270_CSD,
    CMW270_SEIDX,
} CMW270_ACTION_CATEGORY, *P_CMW270_ACTION_CATEGORY;
#endif /* NR_PD_DETECTION */
...
#ifdef NR_PD_DETECTION
typedef struct _CMD_CMD_CMW270_TX_CTRL_T
{
    UINT8    ucCMW270CtrlFormatId;
    BOOLEAN  fgTxConfigEn;
    UINT8    ucReserved[2];
} CMD_CMW270_TX_CTRL_T, *P_CMD_CMW270_TX_CTRL_T;

typedef struct _CMD_CMD_CMW270_RX_CTRL_T
{
    UINT8    ucCMW270CtrlFormatId;
    BOOLEAN  fgRxConfigEn;
    UINT8    ucRxAntIdx;
    UINT8    ucReserved;
} CMD_CMW270_RX_CTRL_T, *P_CMD_CMW270_RX_CTRL_T;

typedef struct _CMD_CMD_CMW270_TXPWR_CTRL_T
{
    UINT8    ucCMW270CtrlFormatId;
    BOOLEAN  fgTxPwrConfigEn;
    UINT8    ucDbdcBandIdx;
    UINT8    ucReserved;
} CMD_CMW270_TXPWR_CTRL_T, *P_CMD_CMW270_TXPWR_CTRL_T;

typedef struct _CMD_CMD_CMW270_ACI_CTRL_T
{
    UINT8    ucCMW270CtrlFormatId;
    BOOLEAN  fgACIConfigEn;
    UINT8    ucDbdcBandIdx;
    UINT8    ucReserved;
} CMD_CMW270_ACI_CTRL_T, *P_CMD_CMW270_ACI_CTRL_T;

typedef struct _CMD_CMD_CMW270_RCPI_CTRL_T
{
    UINT8    ucCMW270CtrlFormatId;
    BOOLEAN  fgRCPIConfigEn;
    UINT8    ucReserved[2];
} CMD_CMW270_RCPI_CTRL_T, *P_CMD_CMW270_RCPI_CTRL_T;

typedef struct _CMD_CMD_CMW270_CSD_CTRL_T
{
    UINT8    ucCMW270CtrlFormatId;
    BOOLEAN  fgCSDConfigEn;
    UINT8    ucDbdcBandIdx;
    UINT8    ucReserved;
} CMD_CMW270_CSD_CTRL_T, *P_CMD_CMW270_CSD_CTRL_T;

typedef struct _CMD_CMD_CMW270_SEIDX_CTRL_T
{
    UINT8    ucCMW270CtrlFormatId;
    BOOLEAN  fgSeIdxConfigEn;
    UINT8    ucReserved[2];
} CMD_CMW270_SEIDX_CTRL_T, *P_CMD_CMW270_SEIDX_CTRL_T;
#endif /* NR_PD_DETECTION */
...
#ifdef NR_PD_DETECTION
INT32 MtCmdLinkTestTxCtrl(struct _RTMP_ADAPTER *pAd, BOOLEAN fgTxConfigEn);
INT32 MtCmdLinkTestRxCtrl(struct _RTMP_ADAPTER *pAd, BOOLEAN fgRxConfigEn, UINT8 ucRxAntIdx);
INT32 MtCmdLinkTestTxPwrCtrl(struct _RTMP_ADAPTER *pAd, BOOLEAN fgTxPwrConfigEn, UINT8 ucDbdcBandIdx);
INT32 MtCmdLinkTestACICtrl(struct _RTMP_ADAPTER *pAd, BOOLEAN fgACIConfigEn, UINT8 ucDbdcBandIdx);
INT32 MtCmdLinkTestRCPICtrl(struct _RTMP_ADAPTER *pAd, BOOLEAN fgRCPIConfigEn);
INT32 MtCmdLinkTestCSDCtrl(struct _RTMP_ADAPTER *pAd, BOOLEAN fgCSDConfigEn, UINT8 ucDbdcBandIdx);
