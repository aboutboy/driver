...
/******************************************************************************
	TMAC_TXD_7
******************************************************************************/
#define PSE_FID_PP_REF_TYPE_MASK		0x3
#define PSE_FID_PP_REF_TYPE_BIT		20
#define PSE_FID_PP_REF_SUBTYPE_MASK	0xf
#define PSE_FID_PP_REF_SUBTYPE_BIT	16
#ifdef RT_BIG_ENDIAN
typedef struct GNU_PACKED _TMAC_TXD_7 {
	UINT32 pse_fid:10;
	UINT32 pp_ref_type:2;
	UINT32 pp_ref_subtype: 4;
	UINT32 spe_idx:5;
	UINT32 rsv_10:1;
	UINT32 hw_rsv_tx_time:2;
	UINT32 sw_tx_time:8;
...
INT dump_dmac_mib_info(struct _RTMP_ADAPTER *pAd, RTMP_STRING *arg);
