...
VOID vow_update_om_wmm(PRTMP_ADAPTER pad, struct wifi_dev *wdev, PEDCA_PARM pApEdcaParm) 
{
    ...
    PEDCA_PARM pBssEdcaParm = &pad->ApCfg.BssEdcaParm;
    ...
    IN  RTMP_STRING *arg)
{
    ...
    MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL, DBG_LVL_ERROR, 
        ("%s: nonwifi %u/%u, obss %u/%u.\n", __FUNCTION__, counter[0], counter[1], counter[2], counter[3]));
