...
#elif defined(MT7636) || defined(MT7637)
...
#ifndef NEWSEC
#define IS_AKM_1X_Entry(_Entry)     (((_Entry)->AuthMode == Ndis802_11AuthModeWPA) || ((_Entry)->AuthMode == Ndis802_11AuthModeWPA2))
#ifdef DOT1X_SUPPORT
#define IS_IEEE8021X_Entry(_Entry)     ((_Entry)->IEEE8021X == TRUE)
#endif
#define IS_AKM_WPA_CAPABILITY_Entry(_Entry)     ((_Entry)->AuthMode >= Ndis802_11AuthModeWPA)
#define IS_AKM_PSK_Entry(_Entry)   (((_Entry)->AuthMode == Ndis802_11AuthModeWPAPSK) || ((_Entry)->AuthMode == Ndis802_11AuthModeWPA2PSK))
#define IS_AKM_FT_WPAPSKWPA2PSK_Entry(_Entry)		((_Entry)->AuthMode == Ndis802_11AuthModeWPA1PSKWPA2PSK)

#define IS_SECURITY_Entry(_Entry)    ((_Entry)->WepStatus != Ndis802_11EncryptionDisabled)
#define IS_AKM_WPA1_Entry(_Entry)                          ((_Entry)->AuthMode == Ndis802_11AuthModeWPA)
#define IS_AKM_WPA1PSK_Entry(_Entry)                          ((_Entry)->AuthMode == Ndis802_11AuthModeWPAPSK)
#define IS_AKM_WPA2_Entry(_Entry)                          ((_Entry)->AuthMode == Ndis802_11AuthModeWPA2)
#define IS_AKM_WPA2PSK_Entry(_Entry)                          ((_Entry)->AuthMode == Ndis802_11AuthModeWPA2PSK)
#define IS_CIPHER_TKIP(_CipherAlg)              ((_CipherAlg) == CIPHER_TKIP)
#define IS_CIPHER_NONE(_CipherAlg)			((_CipherAlg) == CIPHER_NONE)
#define IS_CIPHER_WEP_Entry(_Entry)		((_Entry)->WepStatus == Ndis802_11WEPEnabled)
#define IS_CIPHER_TKIP_Entry(_Entry)              ((_Entry)->WepStatus == Ndis802_11TKIPEnable)
#define IS_CIPHER_AES_Entry(_Entry)              ((_Entry)->WepStatus == Ndis802_11AESEnable)
#define IS_CIPHER_NONE_OR_WEP_Entry(_Entry)    ((_Entry)->WepStatus <= Ndis802_11WEPDisabled)
#define IS_NO_SECURITY_Entry(_Entry)    (((_Entry)->AuthMode == Ndis802_11AuthModeOpen) && ((_Entry)->WepStatus == Ndis802_11WEPDisabled))

#define IS_SECURITY_OPEN_NONE_Entry(_Entry)   (((_Entry)->AuthMode == Ndis802_11AuthModeOpen) && ((_Entry)->WepStatus == Ndis802_11WEPDisabled))

#define IS_SECURITY_SHARED_WEP_Entry(_Entry)   ((_Entry)->AuthMode == Ndis802_11AuthModeShared)
#define IS_SECURITY_AUTOSWITCH_Entry(_Entry)   ((_Entry)->AuthMode == Ndis802_11AuthModeAutoSwitch)

#define SET_AKM_OPEN_Entry(_Entry)               ((_Entry)->AuthMode = Ndis802_11AuthModeOpen)
#define SET_CIPHER_NONE_Entry(_Entry)          ((_Entry)->WepStatus  = Ndis802_11EncryptionDisabled)
