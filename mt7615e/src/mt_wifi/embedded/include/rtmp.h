...
*/
#define REPORT_MGMT_FRAME_TO_MLME(_pAd, Wcid, _pFrame, _FrameSize, _Rssi0, _Rssi1, _Rssi2, _Rssi3, _MinSNR, _channel, _OpMode, _wdev)        \
do{                                                                                       \
    ...
    MlmeEnqueueForRecv(_pAd, Wcid, &_rssi_info, _FrameSize, _pFrame, _OpMode, _wdev);   \
}while(0)
...
typedef struct _COMMON_CONFIG {
    ...
    UCHAR SKUenable;
    UCHAR SKUTableIdx;
    INT8  cTxPowerCompBackup[BAND_NUM][SKU_TABLE_BACKUP_VHT_NUM];
#endif /* SINGLE_SKU_V2 */
	...
	EDCA_PARM APEdcaParm[WMM_NUM_OF_AC];	/* EDCA parameters of the current associated AP */
...
INT TxPowerSKUCtrl(PRTMP_ADAPTER pAd, BOOLEAN fgTxPowerSKUEn);
