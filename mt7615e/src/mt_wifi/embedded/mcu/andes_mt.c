...
VOID EventTxPowerShowInfo(RTMP_ADAPTER *pAd, UINT8 *Data, UINT32 Length)
{
    ...
    BOOLEAN  fg5GEPA;
	UCHAR    SKUEnable;
    INT8     SKUTable_B0[SKU_SIZE];
    INT8     SKUTable_B1[SKU_SIZE];
    ...
    MTWF_LOG(DBG_CAT_FW, DBG_SUBCAT_ALL, DBG_LVL_OFF,("EventTxPowerInfo In \n"));
    ...
    /* SKU Info */
	SKUEnable = prEventTxPowerInfo->ucSKUEnable;
    ...
    PERCENTAGEEnable    = prEventTxPowerInfo->ucPERCENTAGEEnable;
    PowerDrop_B0        = prEventTxPowerInfo->ucPowerDrop_B0;
    PowerDrop_B1        = prEventTxPowerInfo->ucPowerDrop_B1;

    /* BF Backoff Info */
    BFBACKOFFEnable     = prEventTxPowerInfo->ucBFBACKOFFEnable;
    ...
    MTWF_LOG(DBG_CAT_FW, DBG_SUBCAT_ALL, DBG_LVL_OFF,("  SKU Enable = %d                                                             \n", SKUEnable));
    ...
    MTWF_LOG(DBG_CAT_FW, DBG_SUBCAT_ALL, DBG_LVL_OFF,("  Power Percentage Enable = 0x%x                                              \n", PERCENTAGEEnable));
    MTWF_LOG(DBG_CAT_FW, DBG_SUBCAT_ALL, DBG_LVL_OFF,("  PowerDropBand0 = 0x%x                                                       \n", PowerDrop_B0));
    MTWF_LOG(DBG_CAT_FW, DBG_SUBCAT_ALL, DBG_LVL_OFF,("  PowerDropBand1 = 0x%x                                                       \n", PowerDrop_B1));
    ...
    MTWF_LOG(DBG_CAT_FW, DBG_SUBCAT_ALL, DBG_LVL_OFF,("  BF BACKOFF Enable = %d                                                      \n", BFBACKOFFEnable));
...
VOID EventTxPowerCompTable(RTMP_ADAPTER *pAd, UINT8 *Data, UINT32 Length)
{
    ...
    for (ucPowerTblIdx = 0; ucPowerTblIdx < SKU_TABLE_BACKUP_VHT_NUM; ucPowerTblIdx++)
    {
        pAd->CommonCfg.cTxPowerCompBackup[BAND0][ucPowerTblIdx] = prEventTxPowerCompTable->cTxPowerCompBackup[BAND0][ucPowerTblIdx];
        pAd->CommonCfg.cTxPowerCompBackup[BAND1][ucPowerTblIdx] = prEventTxPowerCompTable->cTxPowerCompBackup[BAND1][ucPowerTblIdx];
    }
