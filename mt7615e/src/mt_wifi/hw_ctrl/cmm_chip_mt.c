...
{    
    ...
    {
        RTMP_RADIO_ON_OFF_CTRL(pAd, HcGetBandByWdev(wdev), WIFI_RADIO_ON);
    }
    ...
    HcSetRadioCurStatByWdev(wdev, PHY_INUSE);
}
...
{    
    ...
    /* Set Radio off flag*/
    HcSetRadioCurStatByWdev(wdev, PHY_RADIOOFF);
    ...
    {
        RTMP_RADIO_ON_OFF_CTRL(pAd, HcGetBandByWdev(wdev), WIFI_RADIO_OFF);	
    }
}
