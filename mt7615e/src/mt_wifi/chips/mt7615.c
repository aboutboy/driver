...
static void mt7615_switch_channel(RTMP_ADAPTER *pAd, MT_SWITCH_CHANNEL_CFG SwChCfg)
{
    ...
    if(ATE_ON(pAd) == FALSE)
    {
       ...
       if (SwChCfg.Channel_Band == 0) // Not 802.11j
        ...
        /* BF Backoff Mode Configuration */
        g_BFBackOffMode = pAd->CommonCfg.TxStream;
        ...
        if (pAd->CommonCfg.BFBACKOFFenable)
        {
...
static UINT32 ICAL_JUST_MERGE[] = {0x118, 0x3ac, 0x3ad, 0x3ae, 0x3af, 0x3b0, 0x3b1, 0x3b2}; //merge but nott check
