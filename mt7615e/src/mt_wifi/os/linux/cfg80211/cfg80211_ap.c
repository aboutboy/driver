	...
	UINT                                            threshold)
{
	PRTMP_ADAPTER pAd = (PRTMP_ADAPTER)pAdOrg;
		...
		MTWF_LOG(DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_ERROR,("%s =====>threshold %d pAd->CommonCfg.RtsThreshold %d\n"
			, __FUNCTION__,threshold,pAd->CommonCfg.RtsThreshold));
}
	...
	UINT                                            threshold)
{
		...
		MTWF_LOG(DBG_CAT_SEC, DBG_SUBCAT_ALL, DBG_LVL_ERROR,("%s =====>threshold %d pAd->CommonCfg.FragmentThreshold %d\n"
			, __FUNCTION__,threshold,pAd->CommonCfg.FragmentThreshold));
