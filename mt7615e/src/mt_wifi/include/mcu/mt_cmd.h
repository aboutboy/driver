...
#define BAND1                       1
#define BAND_NUM                    2
#define SKU_TABLE_BACKUP_VHT_NUM   28
...
typedef struct GNU_PACKED _EXT_CMD_CHAN_SWITCH_T {
    ...
    UINT8	ucDbdcIdx;
    UINT8	ucCentralCh2;
    UINT16	u2CacCase;//Jelly20150226
    UINT8	ucBand;
    UINT8	aucReserve0[1];
	UINT8   ucTxPowerDrop;
...
typedef struct GNU_PACKED _EXT_EVENT_TXPOWER_INFO_T {
    ...
    INT8    cSKUTable_B0[SKU_SIZE];
    UINT8   aucReserve1[3];
    
    INT8    cSKUTable_B1[SKU_SIZE];
    UINT8   aucReserve2[3];
...
VOID WtblDwSet(struct _RTMP_ADAPTER *pAd, UINT8 ucWlanIdx, UINT8 ucWtbl1234, UINT8 ucWhichDW, UINT32 u4DwMask, UINT32 u4DwValue);
...
INT32 CmdMcastCloneEnable(struct _RTMP_ADAPTER *pAd, BOOLEAN Enable);
...
INT32 MtCmdTxPowerSKUCtrl(struct _RTMP_ADAPTER *pAd, BOOLEAN fgTxPowerSKUEn);
INT32 MtCmdTxPowerPercentCtrl(struct _RTMP_ADAPTER *pAd, BOOLEAN fgTxPowerPercentEn);
INT32 MtCmdTxBfBackoffCtrl(struct _RTMP_ADAPTER *pAd, BOOLEAN fgTxBFBackoffEn);
